...
class  C2105052Lexer : public antlr4::Lexer {
public:
  enum {
  ...
  explicit C2105052Lexer(antlr4::CharStream *input);

  ~C2105052Lexer() override;
...
private:
  ...
  void UNRECOGNIZEDAction(antlr4::RuleContext *context, size_t actionIndex);
