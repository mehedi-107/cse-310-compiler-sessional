	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			((StartContext)_localctx).p = program(0);
			          ...
			          writeIntoparserLogFile("Line " + std::to_string( ((StartContext)_localctx).p.line) + ": start : program\n");
			          // Print the complete symbol table
			          std::streambuf *oldCout3 = std::cout.rdbuf(parserLogFile.rdbuf());
			          symbolTable->print_all_scope_in_file(parserLogFile);
			          writeIntoparserLogFile("");
			          writeIntoparserLogFile("Total number of lines: " + std::to_string(((StartContext)_localctx).p.line));
	...
	private ProgramContext program(int _p) throws RecognitionException {
		...
		try {
			...
			((Program_unitContext)_localctx).u = unit();
			        ...
			        writeIntoparserLogFile("Line " + std::to_string(((Program_unitContext)_localctx).u.line) + ": program : unit\n");
			        ((Program_unitContext)_localctx).code =  std::vector<std::string>();
			        for (const auto &line : ((Program_unitContext)_localctx).u.unit_code) {
			            _localctx.code.push_back(line);
			            writeIntoparserLogFile(line);
			        }
			        ((Program_unitContext)_localctx).line =  ((Program_unitContext)_localctx).u.line;
			        writeIntoparserLogFile("");
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					((Program_program_unitContext)_localctx).u = unit();
					                  ...
					                  writeIntoparserLogFile("Line " + std::to_string(((Program_program_unitContext)_localctx).u.line) + ": program : program unit\n");
					                  ((Program_program_unitContext)_localctx).code =  ((Program_program_unitContext)_localctx).p.code;
					                  for (const auto &line : ((Program_program_unitContext)_localctx).u.unit_code) {
					                      _localctx.code.push_back(line);
					                  }
					                  ...
					                  writeIntoparserLogFile("");
					                  ((Program_program_unitContext)_localctx).line =  ((Program_program_unitContext)_localctx).u.line;
		...
		try {
			...
			case 1:
				...
				((UnitContext)_localctx).v = var_declaration();
				        ...
				        writeIntoparserLogFile("Line " + std::to_string(((UnitContext)_localctx).v.line) + ": unit : var_declaration\n");
				        writeIntoparserLogFile(((UnitContext)_localctx).v.txt+ "\n"); 
				        ((UnitContext)_localctx).unit_code =  std::vector<string>();
				        _localctx.unit_code.push_back(((UnitContext)_localctx).v.txt);
				        ((UnitContext)_localctx).line =  ((UnitContext)_localctx).v.line;
			...
			case 2:
				...
				((UnitContext)_localctx).f = func_declaration();
				        ...
				        writeIntoparserLogFile("Line " + std::to_string(((UnitContext)_localctx).f.line) + ": unit : func_declaration\n");
				        writeIntoparserLogFile(((UnitContext)_localctx).f.func_def + "\n");
				        ((UnitContext)_localctx).unit_code =  std::vector<string>();
				        _localctx.unit_code.push_back(((UnitContext)_localctx).f.func_def);
				        ((UnitContext)_localctx).line =  ((UnitContext)_localctx).f.line;
			...
			case 3:
				...
				((UnitContext)_localctx).f_def = func_definition();
				        ...
				        writeIntoparserLogFile("Line " + std::to_string(((UnitContext)_localctx).f_def.line) + ": unit : func_definition\n");
				        ((UnitContext)_localctx).unit_code =  std::vector<string>();
				        for (const auto &line : ((UnitContext)_localctx).f_def.code) {
				            writeIntoparserLogFile(line);
			...
			case 1:
				...
				match(SEMICOLON);
				          ...
				          string str = funcType + " " + funcName + "(";
				            for (size_t i = 0; i < ((Func_declarationContext)_localctx).pl.params.size(); ++i) {
				                str += ((Func_declarationContext)_localctx).pl.params[i].first + " " + ((Func_declarationContext)_localctx).pl.params[i].second;
				                if (i < ((Func_declarationContext)_localctx).pl.params.size() - 1) {
				                    str += ",";
				                }
				            }
				            str += ");";
				            ((Func_declarationContext)_localctx).func_def =  str;
				            ((Func_declarationContext)_localctx).line =  ((Func_declarationContext)_localctx).id->getLine();
			...
			case 2:
				...
				match(SEMICOLON);
				          ...
				          SymbolInfo *existing2 = symbolTable->look_up(funcName);
				            ...
				            ((Func_declarationContext)_localctx).func_def =  str2;
				            ((Func_declarationContext)_localctx).line =  ((Func_declarationContext)_localctx).id->getLine();
		...
		try {
			...
			case 1:
				...
				match(RPAREN);
				         ...
				         for (const auto &param : ((Func_definitionContext)_localctx).pl.params) {
				...
				((Func_definitionContext)_localctx).c = ((Func_definitionContext)_localctx).compound_statement = compound_statement(((Func_definitionContext)_localctx).pl.params);
				        ...
				        ((Func_definitionContext)_localctx).code =  vector<string>();
				         voidFuncRetTypeCheck(((Func_definitionContext)_localctx).id->getText(), ((Func_definitionContext)_localctx).t.txt, ((Func_definitionContext)_localctx).c.code, ((Func_definitionContext)_localctx).c.line);
				        ...
				        if(((Func_definitionContext)_localctx).id->getText()!="main"){
				            ...
				            if(func_return_label != -1) {
				                code[func_return_label] = "\tJMP L" + std::to_string(label_count) + "\t\t; line " + std::to_string(((Func_definitionContext)_localctx).c.line);
			...
			case 2:
				...
				((Func_definitionContext)_localctx).cs = compound_statement(vector<pair<string,string>>());
				        ...
				        ((Func_definitionContext)_localctx).code =  vector<string>();
				        voidFuncRetTypeCheck(((Func_definitionContext)_localctx).id->getText(), ((Func_definitionContext)_localctx).t.txt, ((Func_definitionContext)_localctx).cs.code, ((Func_definitionContext)_localctx).cs.line);
				        ...
				        writeIntoparserLogFile("");
				        ((Func_definitionContext)_localctx).line =  ((Func_definitionContext)_localctx).cs.line; inFunc--;
		...
		try {
			...
			case 4:
				...
				((StatementContext)_localctx).e1 = expression_statement();
				        ...
				        label_count++;
				        code.push_back(ab);
				        curr_line = ((StatementContext)_localctx).LPAREN->getLine();
				...
				match(RPAREN);
				        ...
				        code.push_back(ab);
				        code[statement_label_index] = "\tJMP L" + std::to_string(label_count) + "\t\t; line " + std::to_string(((StatementContext)_localctx).e3.line);
				...
				((StatementContext)_localctx).s = statement();
				        ...
				        code.push_back(ss);
				        code[loop_end_label_index] = "\tJE L" + std::to_string(label_count) + "\t\t; line " + std::to_string(((StatementContext)_localctx).s.line);
			...
			case 5:
				...
				match(RPAREN);
				        ...
				        string str;
				        if(curr_line != ((StatementContext)_localctx).LPAREN->getLine()) {
				            str = "L" + std::to_string(label_count) + ":";
				            label_count++;
				            code.push_back(str);
				            curr_line = ((StatementContext)_localctx).LPAREN->getLine();
				...
				((StatementContext)_localctx).s = statement();
				        ...
				        code[if_label_index] = "\tJE L" + std::to_string(label_count) + "\t\t; line " + std::to_string(((StatementContext)_localctx).s.line);
				        ...
				        for(int i=0;i<if_label.size();i++){
				            code[if_label[i]] = "\tJMP L" + std::to_string(label_count) + "\t\t; line " + std::to_string(((StatementContext)_localctx).s.line);    
				        }
				        if_label.clear();
			...
			case 6:
				...
				((StatementContext)_localctx).s1 = statement();
				         ...
				         str = "\tJMP L" + std::to_string(label_count + 1) + "\t\t; line " + std::to_string(((StatementContext)_localctx).s1.line);
				        code.push_back(str);
				...
				match(ELSE);
				        ...
				        code[if_label_index] = "\tJE L" + std::to_string(label_count) + "\t\t; line " + std::to_string(((StatementContext)_localctx).ex.line);
				        if_label_index = -1; // Reset the index after using it
				...
				((StatementContext)_localctx).s2 = statement();
				        ...
				        if(((StatementContext)_localctx).s2.code.size()>0 && ((StatementContext)_localctx).s2.code[0]=="{"){
				            for(int i=0;i<if_label.size();i++){
				                code[if_label[i]] = "\tJMP L" + std::to_string(label_count) + "\t\t; line " + std::to_string(((StatementContext)_localctx).s2.line);    
				            }
				            if_label.clear();
				        }
			...
			case 7:
				...
				((StatementContext)_localctx).WHILE = match(WHILE);
				        ...
				        label_count++;
				        code.push_back(cd);
				        curr_line = ((StatementContext)_localctx).WHILE->getLine();
				...
				((StatementContext)_localctx).statement = statement();
				        ...
				        code.push_back(ss);
				        code[while_loop_end_label_index] = "\tJE L" + std::to_string(label_count) + "\t\t; line " + std::to_string(((StatementContext)_localctx).statement.line);  
			...
			case 8:
				...
				match(SEMICOLON);
				        ...
				        isValidVariable(((StatementContext)_localctx).ID->getText(), ((StatementContext)_localctx).ID->getText(), ((StatementContext)_localctx).ID->getLine());
				        ((StatementContext)_localctx).code =  vector<string>();
				        ...
				        if(curr_line != ((StatementContext)_localctx).ID->getLine()) {
				            str+="L"+std::to_string(label_count);
				            str+=":";
				            label_count++;
				            code.push_back(str);
				            curr_line = ((StatementContext)_localctx).ID->getLine();
				        }
			...
			case 9:
				...
				match(SEMICOLON);
				        ...
				        string str;
				        if(curr_line != ((StatementContext)_localctx).expr.line) {
				            str = "L" + std::to_string(label_count) + ":";
				            label_count++;
				            code.push_back(str);
				            curr_line = ((StatementContext)_localctx).expr.line;
				        }
				        ...
				        str = "\tJMP L" + std::to_string(label_count) + "\t\t; line " + std::to_string(((StatementContext)_localctx).expr.line);
				        code.push_back(str);
		...
		try {
			...
			case 1:
				...
				((VariableContext)_localctx).ID = match(ID);
				        ...
				        isValidVariable(((VariableContext)_localctx).ID->getText(),((VariableContext)_localctx).ID->getText(), ((VariableContext)_localctx).ID->getLine());
			...
			case 2:
				...
				match(RTHIRD);
				        ...
				        isValidVariable(((VariableContext)_localctx).ID->getText(),str, ((VariableContext)_localctx).ID->getLine());
				        ...
				        // string str2;
				        // str2 = "\tPOP BX\t\t; line " + std::to_string(((VariableContext)_localctx).ID->getLine());
				        // code.push_back(str2);
				        // stack_offset -= 2; // Decrease stack offset by 2 for array index
				        // str2 = "\tMOV AX, " + std::to_string(2) + "\t\t; line " + std::to_string(((VariableContext)_localctx).ID->getLine());
				        // code.push_back(str2);
				        // str2 = "\tMUL BX\t\t; line " + std::to_string(((VariableContext)_localctx).ID->getLine());
				        // code.push_back(str2);
				        // str2 = "\tMOV BX, AX\t\t; line " + std::to_string(((VariableContext)_localctx).ID->getLine());
				        // code.push_back(str2);

				        // SymbolInfo *s = symbolTable->look_up_in_all_scope(((VariableContext)_localctx).ID->getText());

				        // if(s->getScopeId()==1){
				        //     str2 = "\tMOV AX, " + ((VariableContext)_localctx).ID->getText() + "[BX]\t\t; line " + std::to_string(((VariableContext)_localctx).ID->getLine());
				        //     code.push_back(str2);
				        // }
				        // else{
				        //     str2 = "\tMOV AX, "+ std::to_string(s->getOffset());
				        //     code.push_back(str2);
				        //     str2 = "\tSUB AX, BX\t\t; line " + std::to_string(((VariableContext)_localctx).ID->getLine());
				        //     code.push_back(str2);
				        //     str2 = "\tMOV BX, AX";
				        //     code.push_back(str2);
				        //     str2 = "\tMOV SI, BX";
				        ...
				        //     str2 = "\tMOV AX, [BP + SI]";
				        //     code.push_back(str2);
				        //     str2 = "\tPUSH AX\t\t; line " + std::to_string(((VariableContext)_localctx).ID->getLine());
				        //     code.push_back(str2);
		...
		try {
			...
			case 2:
				...
				((ExpressionContext)_localctx).l_expr = logic_expression();
				        ...
				        assignOpcheck(((ExpressionContext)_localctx).var.varName, logicExpr, ((ExpressionContext)_localctx).l_expr.line);
				        ((ExpressionContext)_localctx).line =  ((ExpressionContext)_localctx).l_expr.line;
				        writeIntoparserLogFile(_localctx.str + "\n");

				        handle_assign_op(code,symbolTable, ((ExpressionContext)_localctx).var.varName, stack_offset, asmFile);
		...
		try {
			...
			case 2:
				...
				((Logic_expressionContext)_localctx).r2 = rel_expression();
				        ...
				        if(curr_line != ((Logic_expressionContext)_localctx).r1.line){
				            string str = "L" + std::to_string(label_count) + ":";
				            label_count++;
				            code.push_back(str);
				            curr_line = ((Logic_expressionContext)_localctx).r1.line;
				        }
				        SymbolInfo *s = symbolTable->look_up_in_all_scope(((Logic_expressionContext)_localctx).r1.simple_expr.back());
				        if(s!=nullptr){
				            if(s->getScopeId()==1){
				                str = "\tMOV AX, " + ((Logic_expressionContext)_localctx).r2.simple_expr.back() + "\t\t; line " + std::to_string(((Logic_expressionContext)_localctx).r2.line);
				                code.push_back(str);    
				            }
				            else{
				        ...
				        if(((Logic_expressionContext)_localctx).LOGICOP->getText()=="||"){
				            str = "\tCMP AX, 0";
				            code.push_back(str);
				            str = "\tJNE L" + std::to_string(label_count) + "\t\t; line " + std::to_string(((Logic_expressionContext)_localctx).r1.line);
				            code.push_back(str);
				            s = symbolTable->look_up_in_all_scope(((Logic_expressionContext)_localctx).r2.simple_expr.back());
				            if(s!=nullptr){
				                if(s->getScopeId()==1){
				                    str = "\tMOV AX, " + ((Logic_expressionContext)_localctx).r2.simple_expr.back() + "\t\t; line " + std::to_string(((Logic_expressionContext)_localctx).r2.line);
				                    code.push_back(str);
				            ...
				            str = "\tCMP AX, 0";
				            code.push_back(str);
				            str = "\tJNE L" + std::to_string(label_count+1) + "\t\t; line " + std::to_string(((Logic_expressionContext)_localctx).r1.line);
				            code.push_back(str);

				            str = "L" + std::to_string(label_count) + ":";
				            label_count++;
				            code.push_back(str);
				            str = "\tMOV AX, 1\t\t; line " + std::to_string(((Logic_expressionContext)_localctx).r1.line);
				            code.push_back(str);
				            ...
				            str = "\tCMP AX, 0";
				            code.push_back(str);
				            str = "\tJE L" + std::to_string(label_count+1) + "\t\t; line " + std::to_string(((Logic_expressionContext)_localctx).r1.line);
				            code.push_back(str);
				            s = symbolTable->look_up_in_all_scope(((Logic_expressionContext)_localctx).r2.simple_expr.back());
				            if(s!=nullptr){
				                if(s->getScopeId()==1){
		...
		try {
			...
			case 2:
				...
				((Rel_expressionContext)_localctx).ss = simple_expression(0);
				        ...
				        if(curr_line != ((Rel_expressionContext)_localctx).s_expr.line){
				            string str = "L" + std::to_string(label_count) + ":";
				            label_count++;
				            code.push_back(str);
				            curr_line = ((Rel_expressionContext)_localctx).s_expr.line;
				        }


				        SymbolInfo *s = symbolTable->look_up_in_all_scope(((Rel_expressionContext)_localctx).ss.terms.back());
				        if(s!=nullptr){
				            if(s->getScopeId()==1){
				                str = "\tMOV AX, " + ((Rel_expressionContext)_localctx).ss.terms.back() + "\t\t; line " + std::to_string(((Rel_expressionContext)_localctx).ss.line);
				                code.push_back(str);    
				                str = "\tMOV DX, AX";
				                code.push_back(str);
				            }
				            else{
				                str = "\tMOV AX, [BP" + std::string((s->getOffset() >= 0) ? "-" : "+") + std::to_string(std::abs(s->getOffset())) + "]\t\t; line " + std::to_string(((Rel_expressionContext)_localctx).ss.line);
				                code.push_back(str);
				                str = "\tMOV DX, AX";
				                code.push_back(str);
				            }
				        ...
				        s = symbolTable->look_up_in_all_scope(((Rel_expressionContext)_localctx).s_expr.terms.back());
				        if(s!=nullptr){
				            if(s->getScopeId()==1){
				                str = "\tMOV AX, " + ((Rel_expressionContext)_localctx).s_expr.terms.back() + "\t\t; line " + std::to_string(((Rel_expressionContext)_localctx).s_expr.line);
				                code.push_back(str);
				            }
				            else{
				                str = "\tMOV AX, [BP" + std::string((s->getOffset() >= 0) ? "-" : "+") + std::to_string(std::abs(s->getOffset())) + "]\t\t; line " + std::to_string(((Rel_expressionContext)_localctx).s_expr.line);
				                code.push_back(str);
				            }
				        }
				        else{
				...
				if ( _alt==1 ) {
					...
					case 1:
						...
						((Simple_expressionContext)_localctx).t = term(0);
						                  ...
						                  if(curr_line != ((Simple_expressionContext)_localctx).s.line){
						                      string str = "L" + std::to_string(label_count) + ":";
						                      label_count++;
						                      code.push_back(str);
						                      curr_line = ((Simple_expressionContext)_localctx).s.line;
						                  }
						                  
						                  SymbolInfo *s= symbolTable->look_up_in_all_scope(((Simple_expressionContext)_localctx).t.trm);
						                  if(s!=nullptr){
						                      if(s->getScopeId()==1){
						                          str = "\tMOV AX, " + ((Simple_expressionContext)_localctx).t.trm + "\t\t; line " + std::to_string(((Simple_expressionContext)_localctx).t.line);
						                          code.push_back(str);
						                      }
						                      else{
						                          str = "\tMOV AX, [BP" + std::string((s->getOffset() >= 0) ? "-" : "+") + std::to_string(std::abs(s->getOffset())) + "]\t\t; line " + std::to_string(((Simple_expressionContext)_localctx).t.line);
						                          code.push_back(str);
						                      }
						                  }
						                  else{
						                  ...
						                  if(s!=nullptr){
						                      if(s->getScopeId()==1){
						                          str = "\tMOV AX, " + ((Simple_expressionContext)_localctx).s.terms.back() + "\t\t; line " + std::to_string(((Simple_expressionContext)_localctx).s.line);
						                          code.push_back(str);
						                      }
						                      else{
						                          str = "\tMOV AX, [BP" + std::string((s->getOffset() >= 0) ? "-" : "+") + std::to_string(std::abs(s->getOffset())) + "]\t\t; line " + std::to_string(((Simple_expressionContext)_localctx).s.line);
						                          code.push_back(str);
						                      }
						                  }
						                  else{
					...
					case 2:
						...
						if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
						setState(336);
						((Simple_expressionContext)_localctx).ad = match(ADDOP);
						setState(337);
						((Simple_expressionContext)_localctx).as = match(ASSIGNOP);

						                  ((Simple_expressionContext)_localctx).terms =  vector<string>();
						                  writeIntoErrorFile("Error at line " + std::to_string(((Simple_expressionContext)_localctx).ad->getLine()) + ": syntax error, unexpected ASSIGNOP\n");
						                  writeIntoparserLogFile("Error at line " + std::to_string(((Simple_expressionContext)_localctx).ad->getLine()) + ": syntax error, unexpected ASSIGNOP\n");
						                  syntaxErrorCount++;
						              
						setState(339);
						((Simple_expressionContext)_localctx).t2 = term(0);

						                  writeIntoparserLogFile("Line " + std::to_string(((Simple_expressionContext)_localctx).t2.line) + ": simple_expression : term\n");
						                  writeIntoparserLogFile(((Simple_expressionContext)_localctx).t2.trm+"\n");
						                  _localctx.terms.push_back(((Simple_expressionContext)_localctx).t2.trm);
						                  ((Simple_expressionContext)_localctx).line =  ((Simple_expressionContext)_localctx).t2.line;
				...
				if ( _alt==1 ) {
					...
					case 1:
						...
						((TermContext)_localctx).u = unary_expression();
						                  ...
						                  termExprCheck(((TermContext)_localctx).u.unary_expr, ((TermContext)_localctx).u.line);
						                  termMulOpCheck(((TermContext)_localctx).t.trm, ((TermContext)_localctx).u.unary_expr, ((TermContext)_localctx).MULOP->getText(), ((TermContext)_localctx).t.line);
						                  writeIntoparserLogFile(_localctx.trm + "\n");


						                  string str;
						                  SymbolInfo *s= symbolTable->look_up_in_all_scope(((TermContext)_localctx).u.unary_expr);
						                  if(curr_line != ((TermContext)_localctx).t.line){
						                      str+="L"+std::to_string(label_count);
						                      str+=":";
						                      label_count++;
						                      code.push_back(str);
						                      curr_line = ((TermContext)_localctx).t.line;
						                  }

						                  if(s!=nullptr){
						                      if(s->getScopeId()==1){
						                          str = "\tMOV AX, " + ((TermContext)_localctx).u.unary_expr + "\t\t; line " + std::to_string(((TermContext)_localctx).u.line);
						                          code.push_back(str);
						                          str = "\tMOV CX, AX";
						                          code.push_back(str);
						                      }
						                      else{
						                          str = "\tMOV AX, [BP" + std::string((s->getOffset() >= 0) ? "-" : "+") + std::to_string(std::abs(s->getOffset())) + "]\t\t; line " + std::to_string(((TermContext)_localctx).u.line);
						                          code.push_back(str);
						                          str = "\tMOV CX, AX";
						                          code.push_back(str);
						                      }
						                  ...
						                  s= symbolTable->look_up_in_all_scope(((TermContext)_localctx).t.trm);
						                  if(s!=nullptr){
						                      if(s->getScopeId()==1){
						                          str = "\tMOV AX, " + ((TermContext)_localctx).t.trm + "\t\t; line " + std::to_string(((TermContext)_localctx).t.line);
						                          code.push_back(str);
						                      }
						                      else{
						                          str = "\tMOV AX, [BP" + std::string((s->getOffset() >= 0) ? "-" : "+") + std::to_string(std::abs(s->getOffset())) + "]\t\t; line " + std::to_string(((TermContext)_localctx).t.line);
						                          code.push_back(str);
						                      }
						                  }
						                  else{
		...
		try {
			...
			case ADDOP:
				...
				((Unary_expressionContext)_localctx).unary_expression = unary_expression();
				        ...
				        string str;
				        SymbolInfo *s = symbolTable->look_up_in_all_scope(((Unary_expressionContext)_localctx).unary_expression.unary_expr);
				        if(curr_line != ((Unary_expressionContext)_localctx).unary_expression.line){
				            str = "L" + std::to_string(label_count) + ":";
				            label_count++;
				            code.push_back(str);
				            curr_line = ((Unary_expressionContext)_localctx).unary_expression.line; 
				        }
				        if(s!=nullptr){
				            if(s->getScopeId()==1){
				                str = "\tMOV AX, " + ((Unary_expressionContext)_localctx).unary_expression.unary_expr + "\t\t; line " + std::to_string(((Unary_expressionContext)_localctx).unary_expression.line);
				                code.push_back(str);
				            }
				            else{
				                str = "\tMOV AX, [BP" + std::string((s->getOffset() >= 0) ? "-" : "+") + std::to_string(std::abs(s->getOffset())) + "]\t\t; line " + std::to_string(((Unary_expressionContext)_localctx).unary_expression.line);
				                code.push_back(str);
				            }
				        }
				        else{
			...
			case CONST_FLOAT:
				...
				((Unary_expressionContext)_localctx).fact = factor();
				        ...
				        writeIntoparserLogFile("Line " + std::to_string(((Unary_expressionContext)_localctx).fact.line) + ": unary_expression : factor\n");
				        ...
				        writeIntoparserLogFile(((Unary_expressionContext)_localctx).fact.factorName + "\n");
		...
		try {
			...
			case 1:
				...
				((FactorContext)_localctx).var = variable();
				        ...
				        writeIntoparserLogFile("Line " + std::to_string(((FactorContext)_localctx).var.line) + ": factor : variable\n");
				        ...
				        writeIntoparserLogFile(((FactorContext)_localctx).var.varName + "\n");
			...
			case 2:
				...
				match(RPAREN);
				        ...
				        isValidParameterList(((FactorContext)_localctx).ID->getText(), ((FactorContext)_localctx).ar.arg, ((FactorContext)_localctx).ID->getLine());
				        ...
				        label_count++;
				        code.push_back(str);
				        curr_line = ((FactorContext)_localctx).ID->getLine();

				        for(int i=0;i<((FactorContext)_localctx).ar.arg.size();i++){
				            SymbolInfo *s = symbolTable->look_up_in_all_scope(((FactorContext)_localctx).ar.arg[i]);
				            if(s!=nullptr){
				                if(s->getScopeId()==1){
				                    str = "\tMOV AX, " + ((FactorContext)_localctx).ar.arg[i] + "\t\t; line " + std::to_string(((FactorContext)_localctx).ID->getLine());
				                    code.push_back(str);
				                }
				                else{
				                    str = "\tMOV AX, [BP" + std::string((s->getOffset() >= 0) ? "-" : "+") + std::to_string(std::abs(s->getOffset())) + "]\t\t; line " + std::to_string(((FactorContext)_localctx).ID->getLine());
				                    code.push_back(str);
				                }
				            }
				            else{
			...
			case 3:
				...
				match(RPAREN);
				        ...
				        writeIntoparserLogFile("Line " + std::to_string(((FactorContext)_localctx).exp.line) + ": factor : LPAREN expression RPAREN\n");
			...
			case 4:
				...
				((FactorContext)_localctx).c_int = match(CONST_INT);
				        ...
				        writeIntoparserLogFile("Line " + std::to_string(((FactorContext)_localctx).c_int->getLine()) + ": factor : CONST_INT\n");
				        ...
				        // cout<<"CONST_INT at "<<((FactorContext)_localctx).c_int->getLine()<<endl;
				        writeIntoparserLogFile(((FactorContext)_localctx).c_int->getText() + "\n");

				        string str;
				        
				        if(curr_line != ((FactorContext)_localctx).c_int->getLine()){
				            str+="L"+std::to_string(label_count);
				            str+=":";
				            label_count++;
				            code.push_back(str);
				            curr_line = ((FactorContext)_localctx).c_int->getLine();
				        }
			...
			case 5:
				...
				((FactorContext)_localctx).c_float = match(CONST_FLOAT);
				        ...
				        writeIntoparserLogFile("Line " + std::to_string(((FactorContext)_localctx).c_float->getLine()) + ": factor : CONST_FLOAT\n");
				        ...
				        writeIntoparserLogFile(((FactorContext)_localctx).c_float->getText() + "\n");
			...
			case 6:
				...
				match(INCOP);
				        ...
				        writeIntoparserLogFile("Line " + std::to_string(((FactorContext)_localctx).variable.line) + ": factor : variable INCOP\n");
				        ...
				        // if(curr_line != ((FactorContext)_localctx).variable.line){
				        //     str = "L" + std::to_string(label_count) + ":";
				        //     label_count++;
				        //     code.push_back(str);
				        //     curr_line = ((FactorContext)_localctx).variable.line;
				        // }   
				        str = "L" + std::to_string(label_count) + ":";
				        label_count++;
				        code.push_back(str);
			...
			case 7:
				...
				match(DECOP);
				        ...
				        writeIntoparserLogFile("Line " + std::to_string(((FactorContext)_localctx).variable.line) + ": factor : variable DECOP\n");
				        ((FactorContext)_localctx).factorName =  ((FactorContext)_localctx).variable.varName + "--";
				        ((FactorContext)_localctx).line =  ((FactorContext)_localctx).variable.line;
				        writeIntoparserLogFile(_localctx.factorName + "\n");
		...
		try {
			...
			case CONST_FLOAT:
				...
				((Argument_listContext)_localctx).ar = arguments(0);
				        ...
				        writeIntoparserLogFile("Line " + std::to_string(((Argument_listContext)_localctx).ar.line) + ": argument_list : arguments\n");
	...
	private ArgumentsContext arguments(int _p) throws RecognitionException {
		...
		try {
			...
			((ArgumentsContext)_localctx).l = logic_expression();
			        ...
			        writeIntoparserLogFile("Line " + std::to_string(((ArgumentsContext)_localctx).l.line) + ": arguments : logic_expression\n");
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					((ArgumentsContext)_localctx).l = logic_expression();
					                  ...
					                  writeIntoparserLogFile("Line " + std::to_string(((ArgumentsContext)_localctx).l.line) + ": arguments : arguments COMMA logic_expression\n");
