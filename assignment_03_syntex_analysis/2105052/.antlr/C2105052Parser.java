// Generated from d:/3-1/compiler_cse_310/assignment_03_syntex_analysis/2105052/C2105052Parser.g4 by ANTLR 4.13.1
	...
	private ProgramContext program(int _p) throws RecognitionException {
		...
		try {
			...
			((ProgramContext)_localctx).u = unit();
			        ...
			        writeIntoparserLogFile("Line " + std::to_string(((ProgramContext)_localctx).u.line) + ": program : unit\n");
			        ((ProgramContext)_localctx).code =  std::vector<std::string>();
			        for (const auto &line : ((ProgramContext)_localctx).u.unit_code) {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					((ProgramContext)_localctx).u = unit();
					                  ...
					                  writeIntoparserLogFile("Line " + std::to_string(((ProgramContext)_localctx).u.line) + ": program : program unit\n");
		...
		try {
			...
			case 1:
				...
				((FactorContext)_localctx).var = variable();
				        ...
				        // if (symbolTable->look_up(((FactorContext)_localctx).var.varName) == nullptr) {
				        //     writeIntoErrorFile("Line# " + std::to_string(((FactorContext)_localctx).var.line) + ": variable " + ((FactorContext)_localctx).var.varName + " not declared");
				        //     syntaxErrorCount++;
				        // }
